...
struct VideoList {
    ...
    static let topTen = [
        ...
        Video(imageName: "90-90",
              ...
              description: "What I call the 90/90 Rule of Software Development usually bites new inexperienced developers in the ass. It's the concept that there's the first 90% of building the app... and then there's the second 90%. Let's talk about it. What I call the 90/90 Rule of Software Development usually bites new inexperienced developers in the ass. It's the concept that there's the first 90% of building the app... and then there's the second 90%. Let's talk about it.",
              viewCount: 87569,
